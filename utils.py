...
class Split:
    ...
    def __init__(self, data, k_test, shuffle=True, index=0, generator=True, batch_size=512):
        """
...
class SplitGenerator(tf.keras.utils.Sequence):
    ...
    def __getitem__(self, index):
        ...
        # print('[INFO] INPUT: ', np.vstack(ret_x))
        # print('[INFO] OUTPUT: ', np.vstack(ret_y))
...
class Model:
    ...
    def test_model(self):
        ...
        return [e.get_recall(20), e.get_recall(50), e.get_ncdg(100)]
